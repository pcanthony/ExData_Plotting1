# TO MAKE PLOT2, DO THE FOLLOWING:
# 1. Put the file "household_power_consumption.txt" in your working directory.
# 2. Source this script.
# 3. Run the function makeplot2() at the R command line.
...
#=====The following steps are specific to this plotting script.========
	...
	with(Feb07data, plot(DateTime, as.numeric(Global_active_power), xlab = "", ylab = "Global Active Power (kilowatts)", type = "l"))
